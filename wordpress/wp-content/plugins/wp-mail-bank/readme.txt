=== SMTP - Mail - PHP Mailer - Email Logs | WP Mail Bank ===
...
The most trusted WordPress Mail SMTP and wp-phpmailer Plugin for sending emails that also stores email logs. Reconfigures wp_mail() function.
