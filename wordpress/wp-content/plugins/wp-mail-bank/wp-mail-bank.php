<?php
/**
 * Plugin Name: SMTP - Mail - PHP Mailer - Email Logs | WP Mail Bank
 * Plugin URI: https://mail-bank.tech-banker.com/
 * Description: The most trusted WordPress Mail SMTP and wp-phpmailer Plugin for sending emails that also stores email logs. Reconfigures wp_mail() function.
 * Author: Tech Banker
...
if ( ! defined( 'MAIL_BANK_VERSION_NUMBER' ) ) {
	define( 'MAIL_BANK_VERSION_NUMBER', '3.0.37' );
}
