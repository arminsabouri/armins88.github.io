...
if ( ! is_user_logged_in() ) {
	...
	if ( ! $access_granted ) {
		...
		if ( '1' === $flag ) {
			...
			add_submenu_page( 'mb_email_configuration', $mb_upgrade, $mb_upgrade, 'read', 'https://mail-bank.tech-banker.com/pricing/', false === $check_wp_mail_bank_wizard ? 'mb_mail_bank_welcome_page' : '' );
		}
		/**
