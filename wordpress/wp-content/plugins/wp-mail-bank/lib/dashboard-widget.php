...
<p>Mail Bank will send mail via <b><?php echo esc_attr( $mb_mailer_type ) . esc_attr( $mb_encryption_type ); ?></b> to <b><?php echo esc_attr( $mb_hostname_port ); ?></b> using <b><?php echo esc_attr( $password_authentication ); ?></b><?php echo esc_attr( $mb_authentication ); ?>.</p>
...
<ul class="mb-statistics-list">
	<li class="mb-emails-sent">
		<a href="admin.php?page=mb_email_logs">
			<strong><?php echo esc_attr( $mb_status_sent ); ?> Emails Sent</strong>
		</a>
	</li>
	<li class="mb-emails-not-sent">
		<a href="admin.php?page=mb_email_logs">
			<strong><?php echo esc_attr( $mb_status_not_sent ); ?> Emails Not Sent</strong>
		</a>
	</li>
