					...
					<form id="ux_frm_settings">
						...
						<div class="form-group">
							<label class="control-label">
								...
								<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_settings_debug_mode_tooltip ); ?>" data-placement="right"></i>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_remove_tables_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">*</span>
								</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_monitoring_email_log_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">*</span>
								</label>
