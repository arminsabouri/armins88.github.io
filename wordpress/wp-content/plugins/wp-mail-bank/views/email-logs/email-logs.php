					...
					<form id="ux_frm_email_logs">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_start_date_tooltip ); ?>" data-placement="right"></i>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_end_date_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">* <?php echo ' ( ' . esc_attr( $mb_premium_edition_label ) . ' ) '; ?></span>
								</label>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_limit_records_tooltip ); ?>" data-placement="right"></i>
						...
						<table class="table table-striped table-bordered table-hover table-margin-top" id="ux_tbl_email_logs">
							<thead>
								...
								<th style="width:10%">
									<label>
										<?php echo esc_attr( $mb_email_logs_status ); ?>
									</label>
								</th>
							...
							<tbody id="ux_dynamic_email_logs_table_filter">
								...
								foreach ( $unserialized_email_logs_data as $value ) {
									...
									<td id="ux_email_date_time_<?php echo intval( $value['id'] ); ?>">
										<?php
										echo esc_attr( date_i18n( 'd M Y h:i A', doubleval( $value['timestamp'] ) ) );
										?>
										</td>
										...
										<a href="javascript:void(0);">
											<i class="icon-custom-reload tooltips" data-original-title="<?php echo esc_attr( $mb_resend ); ?>" onclick="premium_edition_notification_mail_bank();" data-placement="top"></i>
										</a> |
										<?php
										if ( isset( $value['debug_mode'] ) ) {
											?>
											<a onclick="premium_edition_notification_mail_bank();">
												<i class="icon-custom-doc tooltips" data-original-title="<?php echo esc_attr( $mb_email_logs_show_outputs ); ?>" data-placement="top"></i>
											</a> |
											<?php
										}
										?>
										<a onclick="premium_edition_notification_mail_bank();">
											<i class="icon-custom-share-alt tooltips" data-original-title="<?php echo esc_attr( $mb_email_logs_show_details ); ?>" data-placement="top"></i>
										</a> |
										<a href="javascript:void(0);">
											<i class="icon-custom-trash tooltips" data-original-title="<?php echo esc_attr( $mb_email_logs_delete ); ?>" onclick="premium_edition_notification_mail_bank();" data-placement="top"></i>
										</a>
										</td>
									</tr>
									<?php
