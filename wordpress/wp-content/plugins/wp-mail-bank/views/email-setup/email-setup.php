			...
			<div class="portlet box vivid-green">
				<div class="portlet-title">
					...
					<p class="premium-editions">
						<?php echo esc_attr( $mb_upgrade_kanow_about ); ?> <a href="https://mail-bank.tech-banker.com/" target="_blank" class="premium-edition-text"><?php echo esc_attr( $mb_full_features ); ?></a> <?php echo esc_attr( $mb_chek_our ); ?> <a href="https://mail-bank.tech-banker.com/backend-demos/" target="_blank" class="premium-edition-text"><?php echo esc_attr( $mb_online_demos ); ?></a>
					</p>
				</div>
						...
						<form id="ux_frm_email_configuration">
								...
								<div class="row">
									...
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_enable_from_name_tooltip ); ?>" data-placement="right"></i>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_from_name_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true">*</span>
										</label>
								...
								<div class="row">
									...
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_enable_from_email_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true">*</span>
										</label>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_address_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true">*</span>
										</label>
							...
							<div id="ux_div_second_step" style="display:none">
								<div class="row">
									...
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_email_address_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true">*</span>
										</label>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_reply_to_tooltip ); ?>" data-placement="right"></i>
								...
								<div class="row">
									...
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_cc_email_address_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true"> ( <?php echo esc_attr( $mb_premium_edition_label ); ?> ) </span>
										</label>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_bcc_email_address_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true"> ( <?php echo esc_attr( $mb_premium_edition_label ); ?> ) </span>
										</label>
								...
								<div class="form-group">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_additional_header_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true"> ( <?php echo esc_attr( $mb_premium_edition_label ); ?> )</span>
								</label>
								<textarea class="form-control" id="ux_txt_additional_header" name="ux_txt_additional_header" disabled="disabled" placeholder="<?php echo esc_attr( $mb_additional_header_placeholder ); ?>"><?php echo isset( $email_configuration_array['headers'] ) ? esc_attr( $email_configuration_array['headers'] ) : ''; ?></textarea>
							</div>
								<div class="form-group">
									<label class="control-label">
									<?php echo esc_attr( $mb_email_configuration_mailer_type ); ?> :
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_mailer_type_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">*</span>
								</label>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">
												...
												<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_smtp_host_tooltip ); ?>" data-placement="right"></i>
												<span class="required" aria-required="true">*</span>
											</label>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">
												...
												<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_encryption_tooltip ); ?>" data-placement="right"></i>
												<span class="required" aria-required="true">*</span>
											</label>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">
												...
												<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_smtp_port_tooltip ); ?>" data-placement="right"></i>
												<span class="required" aria-required="true">*</span>
											</label>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">
												...
												<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_authentication_tooltip ); ?>" data-placement="right"></i>
												<span class="required" aria-required="true">*</span>
											</label>
								...
								<div id="ux_div_oauth_authentication">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_client_id_tooltip ); ?>" data-placement="right"></i>
												<span class="required" aria-required="true">*</span>
											</label>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_client_secret_tooltip ); ?>" data-placement="right"></i>
												<span class="required" aria-required="true">*</span>
											</label>
									...
									<div class="form-group">
										<label class="control-label">
											...
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_redirect_uri_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true">*</span>
										</label>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_username_tooltip ); ?>" data-placement="right"></i>
												<span class="required" aria-required="true">*</span>
											</label>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_password_tooltip ); ?>" data-placement="right"></i>
												<span class="required" aria-required="true">*</span>
											</label>
							...
							<form id="ux_frm_test_email_configuration">
								<div id="ux_div_test_mail">
									...
									<label class="control-label">
										...
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_test_email_address_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true">*</span>
									</label>
									...
									<label class="control-label">
										...
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_subject_test_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true">*</span>
									</label>
									...
									<label class="control-label">
										...
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_email_configuration_content_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true">*</span>
									</label>
									<?php
