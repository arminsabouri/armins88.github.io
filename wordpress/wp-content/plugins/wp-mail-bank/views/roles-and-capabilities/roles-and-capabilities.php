					...
					<form id="ux_frm_roles_and_capabilities">
						...
						<div class="form-group">
							<label class="control-label">
								...
								<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_show_menu_tooltip ); ?>" data-placement="right"></i>
						...
						<div class="form-group">
							<label class="control-label">
								...
								<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_topbar_menu_tooltip ); ?>" data-placement="right"></i>
						...
						<div class="form-group">
							<div id="ux_div_administrator_roles">
								<label class="control-label">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_administrator_role_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">* <?php echo '( ' . esc_attr( $mb_premium_edition_label ) . ' )'; ?></span>
								</label>
						...
						<div class="form-group">
							<div id="ux_div_author_roles">
								<label class="control-label">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_author_role_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">* <?php echo '( ' . esc_attr( $mb_premium_edition_label ) . ' )'; ?></span>
								</label>
								<div class="table-margin-top">
						...
						<div class="form-group">
							<div id="ux_div_editor_roles">
								<label class="control-label">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_editor_role_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">* <?php echo '( ' . esc_attr( $mb_premium_edition_label ) . ' )'; ?></span>
								</label>
								<div class="table-margin-top">
						...
						<div class="form-group">
							<div id="ux_div_contributor_roles">
								<label class="control-label">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_contributor_role_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">* <?php echo '( ' . esc_attr( $mb_premium_edition_label ) . ' )'; ?></span>
								</label>
								<div class="table-margin-top">
						...
						<div class="form-group">
							<div id="ux_div_subscriber_roles">
								<label class="control-label">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_subscriber_role_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">* <?php echo '( ' . esc_attr( $mb_premium_edition_label ) . ' )'; ?></span>
								</label>
								<div class="table-margin-top">
						...
						<div class="form-group">
							<div id="ux_div_other_privileges_roles">
								<label class="control-label">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_other_role_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">* <?php echo '( ' . esc_attr( $mb_premium_edition_label ) . ' )'; ?></span>
								</label>
								<div class="table-margin-top">
						...
						<div class="form-group">
							<div id="ux_div_other_roles">
								<label class="control-label">
									...
									<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $mb_roles_capabilities_other_roles_capabilities_tooltip ); ?>" data-placement="right"></i>
									<span class="required" aria-required="true">* <?php echo '( ' . esc_attr( $mb_premium_edition_label ) . ' )'; ?></span>
								</label>
								<div class="table-margin-top">
									...
									<tbody>
										...
										foreach ( $user_capabilities as $key => $value ) {
											...
											if ( 0 === $key % 3 ) {
												...
												<?php
												if ( count( $user_capabilities ) === 1 && 1 === $flag % 3 ) {
													?>
													<td>
													</td>
													<td>
